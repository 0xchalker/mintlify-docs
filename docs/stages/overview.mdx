...
| --- | --- | --- | --- |
| Step 1 | Tạo batch narrative | Trend nào đáng giữ lại? | `.narrative/.../trend-final.md` + optional `x-public-log.*` |
...
Step 1 giờ còn có thêm một lớp public trust:

- nội bộ: `trend-final.md`, `trend-package/`
- công khai: X thread log cho thấy AI đã nghĩ và quyết định như thế nào
